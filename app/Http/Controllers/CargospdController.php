...
class CargospdController extends Controller
{
    ...
    public function index(Request $request)
    {
		...
		$cxd = User::users($request->get('users1'))->orderby('idfacultad','asc')->paginate(15);
		
        return view('cargospd', compact('cxd'))->with('parametros', $parametros)->with('cargospd', $cargospd);
    }
